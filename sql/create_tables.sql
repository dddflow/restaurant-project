...
CREATE TABLE TABLE_SERVICE (
    RESTAURANT_ORDER_ID NUMBER NOT NULL,
    RESTAURANT_TABLE_ID NUMBER NOT NULL,
    STATUS VARCHAR2(50) NOT NULL,
    SERVED_ON DATE NOT NULL,
    CONSTRAINT PK_TABLE_SERVICE PRIMARY KEY (RESTAURANT_ORDER_ID, RESTAURANT_TABLE_ID),
    CONSTRAINT FK_TABLE_SERVICE_RESTAURANT_ORDERS FOREIGN KEY (RESTAURANT_ORDER_ID) REFERENCES RESTAURANT_ORDERS (ID),
    CONSTRAINT FK_TABLE_SERVICE_RESTAURANT_TABLES FOREIGN KEY (RESTAURANT_TABLE_ID) REFERENCES RESTAURANT_TABLES (ID),
    CONSTRAINT CHK_TABLE_SERVICE_STATUS CHECK (STATUS IN ('Pending', 'Served', 'Cancelled'))
);
...
CREATE TABLE DISHES_TO_ORDERS (
    ...
    CONSTRAINT PK_DTO PRIMARY KEY (RESTAURANT_ORDER_ID, DISH_ID),
    CONSTRAINT FK_DTO_RESTAURANT_ORDERS FOREIGN KEY (RESTAURANT_ORDER_ID) REFERENCES RESTAURANT_ORDERS (ID),
